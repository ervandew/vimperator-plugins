/**
 * This is a plugin for vimperator which allows you to select/unselect multiple
 * checkboxes by clicking a checkbox and then dragging to toggle additional
 * check boxes within an area.
 *
 * Note: this is an adaptation of the Greasemonkey script created by
 * Scott Weaver for use as a vimperator plugin:
...
CheckBoxMate = {
    ...
    update: function() {
        ...
        // Replaced all window occurances with window.content for vimperator usage.

        // Added scroll offset
        y = y - window.content.pageYOffset;
        y2 = y2 - window.content.pageYOffset;
        ...
        x = x - window.content.pageXOffset;
        x2 = x2 - window.content.pageXOffset;
...
autocommands.add(['PageLoad'], '.*', ':js CheckBoxMate.init()');
